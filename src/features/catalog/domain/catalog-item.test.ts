...
import { canPurchase, getCatalogTransitionName, isCatalogItemDisplayable, type CatalogItem } from "./catalog-item";
...
describe("canPurchase", () => {
  ...
  it("mantiene nombres seguros para consumidores de transiciones", () => {
    expect(getCatalogTransitionName("CID:TEST/ONE")).toBe("catalog-CID-TEST-ONE");
  });
